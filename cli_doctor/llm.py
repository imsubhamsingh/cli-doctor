...
class llm:
    def __init__(self):
        ...
        self.DEBUG = (
            False  # Set this to True to see the context window being sent to the LLM.
        )
    ...
    def manage_context_window(self):
        ...
        return self.full_message_history[
            -4:
        ]  # Very primitive context window management, truncating the message history to the last 4 messages and losing all prior context.

    def send_message(
        self, prompt: str, role: str = "user", json_response: bool = False
    ):
        """
